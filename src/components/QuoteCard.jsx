...
import { Trash2, Sparkles, Quote, Heart, Edit2, Check, X, BookMarked } from 'lucide-react';

const QuoteCard = ({ item, onDelete, onUpdate, onToggleQuotebook, showInsight = true }) => {
    ...
    return (
        ...
        <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-2 mb-4">
                ...
                {item.inQuotebook ? 'Collection' : 'Discovery'}
                </span>
            </div>
